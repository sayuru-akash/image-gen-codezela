            ...
            <div className="py-10 flex justify-between h-fit items-end-safe">
              ...
              <div className="hidden md:flex gap-2">
                <div className="flex justify-center items-center w-8 h-8 bg-gradient-to-r from-gold from-20% to-white/50 to-80% rounded-full hover:from-dark-blue hover:to-gold border border-gold transition-all cursor-pointer">
                  <MdOutlineArrowLeft className="w-7 h-7 text-white transition-all duration-300" />
                </div>
                <div className="flex justify-center items-center w-8 h-8 bg-gradient-to-r from-gold from-20% to-white/50 to-80% rounded-full hover:from-dark-blue hover:to-gold border border-gold transition-all cursor-pointer">
                  <MdOutlineArrowRight className="w-7 h-7 text-white transition-all duration-300" />
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 py-10">
          ...
          <div className="col-span-2">
            <div className="flex gap-2 w-full overflow-x-auto overflow-y-hidden scrollbar-hide h-32">
              {["/images/logo-1.svg", "/images/logo-2.svg", "/images/logo-3.svg", "/images/logo-4.svg"].map(
                (logo, index) => (
                  <div
                    key={logo}
                    className="flex items-center justify-center rounded-2xl border border-secondary-accent h-32 w-56 flex-shrink-0"
                  >
                    <Image src={logo} alt={`Partner ${index + 1}`} width={200} height={200} />
                  </div>
                )
              )}
            </div>
