        ...
        <div className="bg-white/10 backdrop-blur-xs w-full h-84 rounded-4xl border border-white/30 p-3">
          <div className="relative w-full h-full rounded-2xl overflow-hidden">
            <Image
              ...
              priority
            />
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 p-2 bg-gradient-to-r from-dark-blue/90 from-5% to-gold/80 to-40% w-full h-full rounded-2xl relative z-10">
