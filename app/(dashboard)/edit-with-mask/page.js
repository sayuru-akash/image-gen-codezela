  ...
  const drawBrush = (ctx, x, y, isErasing = false) => {
    ...
    switch (brushType.type) {
      ...
      case "soft":
        ...
        gradient.addColorStop(0.5, `rgba(255, 255, 255, ${brushOpacity * 0.5})`);
        ...
        <div className="relative px-4 py-8 flex flex-col bg-dark-blue border border-white/50 rounded-2xl h-full w-20">
          ...
          <div className="grid justify-items-center w-fit mx-auto">
            <div className="bg-white rounded w-6 h-6 flex items-center mb-8">
              <svg className="w-6 h-6 text-dark-blue" fill="currentColor" viewBox="0 0 20 20">
            ...
            {originalImage && (
              <div className="mt-6 space-y-3 w-full">
                ...
                {/* Brush Size Control */}
                <div className="mt-4">
                  <div className="text-white text-xs text-center mb-2">Size</div>
                  <input
                    type="range"
                    min="5"
                    max="50"
                  ...
                  />
                  <div className="text-white text-xs text-center mt-1">{brushSize}px</div>
                </div>
                
                {/* Brush Opacity Control */}
                <div className="mt-3">
                  <div className="text-white text-xs text-center mb-2">Opacity</div>
                  <input
                    type="range"
                    min="0.1"
                    max="1"
                    ...
                    className={`w-full h-1 bg-gray-700 rounded-lg cursor-pointer ${styles.rangeSlider}`}
                  />
                  <div className="text-white text-xs text-center mt-1">{Math.round(brushOpacity * 100)}%</div>
                </div>
              </div>
            )}
          </div>
          ...
          {!originalImage ? (
            <div className="flex items-center justify-center h-full">
              <div className="text-white/60 text-center">
                <div className="text-xl mb-2">Upload an image to start editing</div>
                <div className="text-sm">Click the image icon on the left to begin</div>
              </div>
            </div>
          ) : (
            <>
              ...
              <div className="absolute top-3 left-3 flex gap-2">
                <button
                  ...
                  className={`px-2 py-1 rounded text-xs font-medium transition-colors ${
                    showOriginal ? 'bg-blue-600 text-white' : 'bg-black/50 text-gray-300 hover:bg-gray-600'
                  }`}
                >
                  Original
                </button>
                <button
                  ...
                  className={`px-2 py-1 rounded text-xs font-medium transition-colors ${
                    showMask ? 'bg-green-600 text-white' : 'bg-black/50 text-gray-300 hover:bg-gray-600'
                  }`}
                >
                  Mask
                </button>
