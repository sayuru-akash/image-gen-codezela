        ...
        <div className="absolute flex justify-between p-2 bottom-5 left-14 right-14 bg-dark-blue border border-white/50 rounded-full h-fit">
          <div className="flex gap-4 items-center">
            ...
            <button
              ...
              className="w-fit bg-gradient-to-r from-yellow-500 from-50% to-white/60 to-95% text-white text-sm font-medium px-8 py-2 rounded-full hover:from-white/20 hover:to-yellow-500 cursor-pointer transition-all duration-500"
            >
              Add Image
            </button>
            ...
            <input
              placeholder="Value"
              className="text-white bg-transparent outline-none transition-all placeholder-white/60"
            />
          </div>
